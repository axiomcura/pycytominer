...
<img style="width: 100%" alt="Description of the pycytominer pipeline. Images flow from feature extraction and are processed with a series of steps" src="https://github.com/axiomcura/pycytominer/blob/image-hotfix/media/pipeline_md.jpg">
